...
//				else if (equal(key, "MAX_HEALTH_ZOMBIE"))
//					MAX_HEALTH_ZOMBIE_RANDOM = str_to_num(value)
				else if (equal(key, "MIN_HEALTH_ZOMBIE"))
					MIN_HEALTH_ZOMBIE_RANDOM = str_to_num(value)
