public plugin_natives()
{
	...
	register_native("bte_zb3_can_use_skill", "native_can_use_skill", 1)
...
{
	return !!BitsGet(g_bitsDNA[id], which)
}
...
{
	return g_iZombieMaxArmor[id]
}
public native_set_max_armor(id,armor)
{
	g_iZombieMaxArmor[id] = armor
}
...
{
	return g_iZombieMaxHealth[id]
}
public native_set_max_health(id,health)
{
	g_iZombieMaxHealth[id] = health
}
