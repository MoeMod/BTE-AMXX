...
native bte_KnifeAttack(id, bStab, Float:fRange, Float:flDamage)
...
public PrimaryAttack(iEnt)
{
	...
	new iHitResult = bte_KnifeAttack(id, 0, DISTANCE[0], DAMAGE[0]);
...
public SecondaryAttack(iEnt)
{
	...
	new iHitResult = bte_KnifeAttack(id, 0, DISTANCE[1], DAMAGE[1]);
